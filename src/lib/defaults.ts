...
export const DEFAULT_COPY: LandingCopy = {
  ...
  hero: {
    ...
    subtitle:
      "Atendimento especializado em estética íntima, emagrecimento e bem-estar para mulheres que querem viver com mais autoestima e prazer.",
  ...
  diferenciais: {
    ...
    cards: [
      {
        kpi: "40+",
        title: "Foco em mulheres 40+",
        desc: "Atendimento direcionado às transformações e necessidades únicas desta fase da vida.",
      },
      {
        kpi: "Humano",
        title: "Atendimento que acolhe",
        desc: "Escuta ativa, tempo de qualidade e decisões compartilhadas em cada consulta.",
      },
      {
        kpi: "+2.000",
        title: "Mulheres atendidas",
        desc: "Pacientes que confiam na Dra. Milena em cada fase da vida.",
      },
      {
        kpi: "Divinópolis",
        title: "Referência regional",
        desc: "Consultório próprio com estrutura completa no centro de Divinópolis - MG.",
      },
    ],
  },
  sobre: {
    ...
    cards: [
      {
        ...
        desc: "Procedimentos modernos com laser e radiofrequência para bem-estar e autoestima feminina.",
      },
      {
        title: "Emagrecimento Personalizado",
        desc: "Protocolo individualizado com avaliação completa e acompanhamento contínuo.",
      },
      {
        title: "Ninfoplastia",
        desc: "Procedimento cirúrgico íntimo com foco em qualidade de vida e autoconfiança.",
      },
      {
        title: "Medicina Integrativa",
        desc: "Abordagem completa que une saúde física, hormonal e emocional.",
      },
      {
        title: "Saúde Hormonal",
        desc: "Equilíbrio hormonal para TPM, menopausa e bem-estar em cada fase da vida.",
      },
      {
        title: "Ginecologia Clínica",
        desc: "Consultas de rotina, exames preventivos e diagnóstico especializado humanizado.",
      },
    ],
  },
  depoimentos: {
    ...
    items: [
      {
        text: "A Dra. Milena mudou completamente minha relação com minha saúde. Ela explica tudo com paciência e me faz sentir segura a cada consulta.",
        author: "Ana Paula M.",
        role: "Paciente há 3 anos",
      },
      {
        text: "Finalmente encontrei uma médica que me trata como pessoa, não como número.",
        author: "Fernanda S.",
        role: "Ginecologia clínica",
      },
      {
        text: "Profissional excepcional. O atendimento é impecável.",
        author: "Juliana T.",
        role: "Saúde hormonal",
      },
    ],
  ...
  localizacao: {
    ...
    phone: "(37) 98815-5040",
    mapsEmbed:
      "https://www.google.com/maps?q=Av.+Get%C3%BAlio+Vargas%2C+805%2C+Centro%2C+Divin%C3%B3polis+-+MG&output=embed",
  },
  contato: {
